...
<main>
	...
	<c:forEach var="view" items="${menuItemList}">
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text" id="menuName">${view.menuName}</p>
              <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted" id="menuPrice">${view.menuPrice}</small>
              </div>
            </div>
  ...
  <div class="album py-5 bs-gray-400 myCart">
    <div class="container">
	  <h3>나의 장바구니</h3>
	...
	<c:forEach var="view" items="${cartItemList}">
        <div class="col">
          <div class="card shadow-sm">            
            ...
            <div class="card-body">
              <p class="card-text" id="menuName">${view.menuName}
              <input type="number" id="wantStock" name="wantStock" value="1"
       			min="1" max="20" style="height:25px; width:35px;">
              </p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">                
                  <button value="${view.menuName}"
                     onclick = "location.href ='delete_cart_item?menuName1=${view.menuName}'"
                   class="btn btn-sm btn-outline-secondary">				
					삭제
				</button>
                  <button type="button" class="btn btn-sm btn-outline-secondary">상세정보</button>
                </div>
                <c:set var="total" value="${total + view.menuPrice}"></c:set>
                <small class="text-muted" id="menuPrice">${view.menuPrice}</small>
              </div>
            </div>
          ...
          <div class="card shadow-sm">            
            ...
            <div class="card-body white">
              <p class="card-text">              
              총 결제금액 : <c:out value="${total}">${total}</c:out>
              </p>
